    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Claim Verifier</h1>
          <p className="text-slate-600">Verify the accuracy of claims using reliable sources</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
          ...
          <div className="p-6 border-b border-slate-100">
            <label htmlFor="claim-input" className="block text-sm font-medium text-slate-700 mb-3">
              Enter your claim
            </label>
          ...
          {/* Results Section */}
          {result && (
            <div className={`mx-6 mb-6 rounded-xl border-2 ${getVerificationColor()} transition-all duration-500`}>
              <div className="p-6">
                {/* Verification Status */}
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900">
                      {result.verified ? 'Claim Verified' : 'Claim Not Verified'}
                    </h3>
                ...
                <div className="pt-4 border-t border-slate-200">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <h4 className="font-medium text-slate-900 mb-1">Sources</h4>
                      <p className="text-sm text-slate-600">
                        {result.source}
                      </p>
                    </div>
        ...
        <div className="text-center mt-8 text-sm text-slate-500">
          <p>Results are based on available information and should be verified independently</p>
        </div>
      </div>
    </div>
  )
